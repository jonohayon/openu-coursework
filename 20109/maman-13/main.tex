...
\subsection{סעיף ב}
לפי תוצאות סעיף א, נוכל לראות שמצאנו ש$K$ ו$M$ הינם מרחבים לינארים )ובפרט תת-מרחבים של $M^\mR_{2\times2}$ ושל $R_4[x]$, בהתאמה(, בעזרת מציאת קבוצות הפורשות אותם. לפיכך הקבוצות הפורשות הן:
\begin{itemize}
